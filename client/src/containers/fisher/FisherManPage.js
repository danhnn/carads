    ...
    return (
      <div style={{ margin: 20 }}>
        ...
        <ColSection>
          ...
          <PResult>
            {
              JSON.stringify(this.props.data.allTunaSuccess ? this.props.data.allTunaSuccess : this.props.data.allTunaError)
            }
          </PResult>
        </ColSection>
      </div>
...
const mapStateToProps = state => {
  console.log("FISHER MAN UPDATE MAP = ", JSON.stringify(state));
  return {
