    ...
    return (
      <div style={{ margin: 20 }}>
        <RowSection>
          ...
          <Button style={{ color: 'red', marginLeft: 100 }} onClick={() => this.onInstantiatedCCClick()}>Go to Fisher Page</Button>
        </RowSection>
        <ColSection>
        ...
        <ColSection>
          <Button onClick={() => this.onInstantiatedCCClick()}>Create Alice Channel</Button>
          <PResult>
            {
              JSON.stringify(this.props.data.instantiatedCCSuccess ? this.props.data.instantiatedCCSuccess : this.props.data.instantiatedCCError)
            }
        ...
        <ColSection>
          <Button onClick={() => this.onInstantiatedCCClick()}>Create Bob Channel</Button>
          <PResult>
            {
              JSON.stringify(this.props.data.instantiatedCCSuccess ? this.props.data.instantiatedCCSuccess : this.props.data.instantiatedCCError)
            }
        ...
        <ColSection>
          <Button onClick={() => this.onInstantiatedCCClick()}>Set price for Alice in Alice channel</Button>
          <PResult>
            {
              JSON.stringify(this.props.data.instantiatedCCSuccess ? this.props.data.instantiatedCCSuccess : this.props.data.instantiatedCCError)
            }
        ...
        <ColSection>
          <Button onClick={() => this.onInstantiatedCCClick()}>Set price for Bob in Bob channel</Button>
          <PResult>
            {
              JSON.stringify(this.props.data.instantiatedCCSuccess ? this.props.data.instantiatedCCSuccess : this.props.data.instantiatedCCError)
            }
...
const mapStateToProps = state => {
  console.log("ADMIN UPDATE MAP = ", JSON.stringify(state))
  return {
