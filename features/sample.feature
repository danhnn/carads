Feature: sample
    ...
    Background:
        ...
        And I have added the following participants of type org.carads.Client
            | clientId | email | company | name | nationalCardImage | nationalId |
            | 5c6745b8-45f5-11e8-842f-0ed5f89f718b | pandg@email.com | P&G | Nguyễn Ngọc Danh | 130592309.jpg | 130592309 |
            | 5c6748ec-45f5-11e8-842f-0ed5f89f718b | unilever@email.com | unilever | Nguyễn Ngọc B | 130592569.jpg | 130592569 |
        And I have added the following participants of type org.carads.Supplier
            | supplierId | email | company | name | nationalCardImage | nationalId |
            | 76bd1c3a-45f5-11e8-842f-0ed5f89f718b | grab@email.com | Grab | Phạm Công Danh | 260592309.jpg | 260592309 |
            | 76bd1ed8-45f5-11e8-842f-0ed5f89f718b | carads@email.com | CarAds | Đinh La Thăng | 270592569.jpg | 270592569 |
        And I have added the following participants of type org.carads.Driver
            | driverId | email | car | name | nationalCardImage | nationalId |
            | 895af98e-45f5-11e8-842f-0ed5f89f718b | hoangtiendat@email.com | 1 | Hoàng Tiến Đạt | 260692309.jpg | 260692309 |
            | 895afc4a-45f5-11e8-842f-0ed5f89f718b | hariwon@email.com | 2 | Hariwon | 260692509.jpg | 260692509 |
        ...
        And I have issued the participant org.carads.Client#5c6748ec-45f5-11e8-842f-0ed5f89f718b with the identity uni
    ...
    Scenario: Create ads and view permission
     ...
     Scenario: client pg can deposit money to supplier grab
        ...
        And I should have the following assets of type org.carads.Client
            | accountId | owner           | balance |
            | 1         | 5c6745b8-45f5-11e8-842f-0ed5f89f718b | 250000000      |
        And I use the identity grab
        Then I should have the following assets of type org.carads.Supplier
            | accountId | owner           | balance |
